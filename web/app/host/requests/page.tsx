  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-2xl text-sm text-[#888]">
        Revisa las solicitudes entrantes. Puedes ajustar fechas o alojamiento antes de aceptar; el huésped podrá
        completar datos cuando el estado pase a «esperando datos».
      </p>
      <HostRequestsClient />
    </div>
  );
